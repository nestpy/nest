...
class TestNestApplication:        
    ...
    def test_ShouldException_WhenInstanceWithCorsNotBool(self): pass
    def test_ShouldException_WhenUseWildcardWithMoreValues(self): pass
    def test_ShouldException_WhenNotUseRequestMethodString(self): pass
